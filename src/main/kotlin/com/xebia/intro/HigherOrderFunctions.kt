 ...
 */
fun Song.belongsToGenreAndReleasedInYear(selectedGenre: Genre, year: Int): Boolean = TODO()
 ...
 */
fun PlayStats.calculateRoyalties(song: Song): Double = TODO()
 ...
 */
fun aggregateRoyaltiesByUsingHigherOrderFunctions(songsLibrary: List<Song>, playStats: PlayStats, genre: Genre, year: Int): Double = TODO()
 ...
 */
fun aggregateRoyaltiesInOneIteration(songsLibrary: List<Song>, playStats: PlayStats, genre: Genre, year: Int): Double = TODO()
